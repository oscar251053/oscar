...
import java.util.ArrayList; // Importación de IOException para manejar excepciones de entrada/salida
import java.util.List; // Importación de todas las clases JDBC para operaciones de base de datos

import javax.servlet.ServletException; // Importación de ArrayList para manejar listas dinámicas de objetos
import javax.servlet.annotation.WebServlet; // Importación de List para manejar colecciones de elementos
...
public class Controlador extends HttpServlet { // Declaración de la clase Controlador que extiende HttpServlet
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String query = "INSERT INTO peliculas (titulo, director, elenco, genero, duracion, sinopsis, fechaDeEstreno, duracion, imagen) VALUES (?, ?, ?, ?, ?, ?. ?. ?. ?)";
